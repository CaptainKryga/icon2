...
#    Updated: 2019/06/06 08:05:37 by jbashiri         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(FDF): $(LIBFT_PRINTF) $(OBJ)
	@$(CC) $(OBJ) $(LIBFT_PRINTF) $(INCLUDE) -L /usr/local/lib/ -lmlx -framework OpenGL -framework AppKit -o $(FDF)
	@echo "fdf compiled"
